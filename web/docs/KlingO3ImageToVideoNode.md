<!-- ABOUTME: Help documentation for the Kling O3 Image-to-Video ComfyUI node. -->
<!-- ABOUTME: Animates a starting image into a short video using Kling O3 models. -->

# Kling O3 Image-to-Video

Animates a starting image into a short video using Kling O3 models via the WaveSpeed AI API. Accepts a text prompt describing the desired motion and an image URL as the starting frame.
...
- **API endpoints:** `/api/v3/kwaivgi/kling-video-o3-std/image-to-video` and `/api/v3/kwaivgi/kling-video-o3-pro/image-to-video`
