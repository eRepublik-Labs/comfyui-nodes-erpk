<!-- ABOUTME: Help documentation for the Bytedance Seedream V5.0 Lite Edit Sequential ComfyUI node. -->
...
Edits images with sequential generation for multiple coherent results at higher minimum resolution (1440px) using ByteDance's Seedream V5.0 Lite Edit Sequential model.
...
- **Pricing:** $0.035/image
- **API Docs:** [Bytedance Seedream V5.0 Lite Edit Sequential](https://wavespeed.ai/docs/docs-api/bytedance/bytedance-seedream-v5-0-lite-edit-sequential)
