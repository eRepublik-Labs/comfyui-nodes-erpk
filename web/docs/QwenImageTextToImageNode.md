<!-- ABOUTME: Help documentation for the Qwen Image Text-to-Image ComfyUI node. -->
<!-- ABOUTME: Generates images from bilingual text prompts using Qwen Image models. -->

# Qwen Image Text-to-Image

Generates high-quality images from text prompts using Qwen Image models. Supports bilingual (Chinese and English) prompts.
...
- **API Docs:** [Qwen Image Text-to-Image](https://wavespeed.ai/docs/docs-api/wavespeed-ai/qwen-image-text-to-image)
- Prompt is required and cannot be empty
- Two model variants available: **Qwen Image** (20B MMDiT, default) and **Qwen Image 2512** (7B, better text rendering)
