<!-- ABOUTME: Help documentation for the Bytedance Seedream V4.5 Edit Sequential ComfyUI node. -->
<!-- ABOUTME: Multi-image editing with sequential generation and enhanced typography. -->

# Bytedance Seedream V4.5 Edit Sequential

Edits images with sequential generation for multiple coherent results and enhanced typography using ByteDance's Seedream V4.5 Edit Sequential model.
...
- **Pricing:** $0.027/image
- **API Docs:** [Bytedance Seedream V4.5 Edit Sequential](https://wavespeed.ai/docs/docs-api/bytedance/bytedance-seedream-v4-5-edit-sequential)
