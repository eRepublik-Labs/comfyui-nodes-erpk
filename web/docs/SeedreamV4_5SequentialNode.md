<!-- ABOUTME: Help documentation for the Bytedance Seedream V4.5 Sequential ComfyUI node. -->
<!-- ABOUTME: Generates multiple coherent images with enhanced typography and cross-image consistency. -->

# Bytedance Seedream V4.5 Sequential

Generates multiple coherent images with cross-image consistency and enhanced typography using ByteDance's Seedream V4.5 Sequential model.
...
- **Pricing:** $0.027/image
- **API Docs:** [Bytedance Seedream V4.5 Sequential](https://wavespeed.ai/docs/docs-api/bytedance/bytedance-seedream-v4-5-sequential)
- The node automatically appends "Generate a set of N consecutive." to your prompt
- All generated images maintain cross-image consistency with enhanced text rendering
