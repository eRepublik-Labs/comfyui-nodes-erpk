Published Time: Fri, 13 Mar 2026 22:12:39 GMT

# How to switch between OpenAI and Azure OpenAI endpoints with Python - Azure OpenAI Service | Microsoft Learn

[Skip to main content](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints#main)[Skip to Ask Learn chat experience](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints#)
...
[Sign in](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints#)

![Image 1](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints)

![Image 2](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints)

*   [Profile](https://learn.microsoft.com/en-us/users/me/activity/)
*   [Settings](https://learn.microsoft.com/en-us/users/me/settings/)

[Sign out](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints#)
...
![Image 3](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints)

![Image 4](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints)
...
*   Get started
    *   [Quickstart](https://learn.microsoft.com/en-us/azure/foundry-classic/quickstarts/get-started-code)
...
*   Models
    ...
    *   [Data, privacy, and security for Model Catalog](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/concept-data-privacy)
    ...
    *   Deployment in AI hub
    *   Azure OpenAI in Foundry Models
        *   [Upgrade from Azure OpenAI Service](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/upgrade-azure-openai)
        *   [Quotas and limits](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/quotas-limits)
        *   [Azure OpenAI Models](https://learn.microsoft.com/en-us/azure/foundry-classic/foundry-models/concepts/models-sold-directly-by-azure)
        ...
        *   [Programming languages/SDKs](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/supported-languages)
        ...
        *   Embeddings
        *   [Evaluation](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/evaluations)
        *   Image & video generation
        *   [Stored completions](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/stored-completions)
        *   [Webhooks](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/webhooks)
        *   Concepts
        *   How-to
            *   Assistants (preview)
            *   [Content filtering](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/content-filters)
            *   [Use blocklists](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/use-blocklists)
            *   [Risks & Safety Monitoring](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/risks-safety-monitor)
            *   Use your data
            *   [Migrate to OpenAI Python v1.x](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/migration)
            ...
            *   [Migrate to Azure OpenAI .NET v2.0](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/dotnet-migration)
            *   Models
            *   Networking and security
            *   Service management
                *   [Resource creation & model deployment](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/create-resource)
                ...
                *   [Dynamic quota](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/dynamic-quota)
                *   [Monitor Azure OpenAI](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/monitor-openai)
                *   [Performance & latency](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/latency)
            ...
            *   [Deploy and use web apps](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/use-web-app)
...
3.   [Microsoft Foundry (classic)](https://learn.microsoft.com/en-us/azure/foundry-classic/)
...
Table of contents[Read in English](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/switching-endpoints)Add to Collections Add to plan[Edit](https://github.com/MicrosoftDocs/azure-ai-docs/blob/main/articles/foundry-classic/openai/how-to/switching-endpoints.yml)

* * *

#### Share via

[Facebook](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fazure%2Ffoundry-classic%2Fopenai%2Fhow-to%2Fswitching-endpoints%3FWT.mc_id%3Dfacebook)[x.com](https://twitter.com/intent/tweet?original_referer=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fazure%2Ffoundry-classic%2Fopenai%2Fhow-to%2Fswitching-endpoints%3FWT.mc_id%3Dtwitter&tw_p=tweetbutton&url=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fazure%2Ffoundry-classic%2Fopenai%2Fhow-to%2Fswitching-endpoints%3FWT.mc_id%3Dtwitter)[LinkedIn](https://www.linkedin.com/feed/?shareActive=true&text=%0A%0D%0Ahttps%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fazure%2Ffoundry-classic%2Fopenai%2Fhow-to%2Fswitching-endpoints%3FWT.mc_id%3Dlinkedin)[Email](mailto:?subject=%5BShared%20Article%5D%20How%20to%20switch%20between%20OpenAI%20and%20Azure%20OpenAI%20endpoints%20with%20Python%20-%20Azure%20OpenAI%20Service%20%7C%20Microsoft%20Learn&body=%0A%0D%0Ahttps%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fazure%2Ffoundry-classic%2Fopenai%2Fhow-to%2Fswitching-endpoints%3FWT.mc_id%3Demail)
...
Access to this page requires authorization. You can try [signing in](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints#) or [changing directories](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints).

Access to this page requires authorization. You can try [changing directories](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints).
...
1.   [Prerequisites](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints#prerequisites)
2.   [Authentication](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints#authentication)
3.   [Keyword argument for model](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints#keyword-argument-for-model)
4.   [Azure OpenAI embeddings multiple input support](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints#azure-openai-embeddings-multiple-input-support)
5.   [Related content](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints#related-content)
...
[](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints#prerequisites)
## Prerequisites

None

[](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints#authentication)
## Authentication
...
OpenAI uses the `model` keyword argument to specify what model to use. Azure OpenAI has the concept of unique model [deployments](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/create-resource?pivots=web-portal#deploy-a-model). When you use Azure OpenAI, `model` should refer to the underlying deployment name you chose when you deployed the model.

Important

When you access the model via the API in Azure OpenAI, you need to refer to the deployment name rather than the underlying model name in API calls, which is one of the [key differences](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints) between OpenAI and Azure OpenAI. OpenAI only requires the model name. Azure OpenAI always requires deployment name, even when using the model parameter. In our docs, we often have examples where deployment names are represented as identical to model names to help indicate which model works with a particular API endpoint. Ultimately your deployment names can follow whatever naming convention is best for your use case.
...
[](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints#related-content)
## Related content

*   [Learn more about how to work the Responses API with our how-to guide](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/responses)
...
[English (United States)](https://learn.microsoft.com/en-us/locale?target=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fazure%2Ffoundry-classic%2Fopenai%2Fhow-to%2Fswitching-endpoints)
