...
\\
Prompt GPT Image for reliable results](https://developers.openai.com/cookbook/examples/multimodal/image-gen-models-prompting-guide) [Image generation demo repo \\
\\
...
[![](https://cdn.openai.com/API/docs/images/images-gallery-2/sci-fi-hangar.png)](https://developers.openai.com/api/docs/guides/image-generation#)[![](https://cdn.openai.com/API/docs/images/images-gallery-2/mechanical-bouquet.png)](https://developers.openai.com/api/docs/guides/image-generation#)[![](https://cdn.openai.com/API/docs/images/images-gallery-2/mechanical-watch.png)](https://developers.openai.com/api/docs/guides/image-generation#)[![](https://cdn.openai.com/API/docs/images/images-gallery-2/botanical-perfume-output.png)](https://developers.openai.com/api/docs/guides/image-generation#)[![](https://cdn.openai.com/API/docs/images/images-gallery-2/lavender-sunrise.png)](https://developers.openai.com/api/docs/guides/image-generation#)[![](https://cdn.openai.com/API/docs/images/images-gallery-2/moon-control-room-1969.png)](https://developers.openai.com/api/docs/guides/image-generation#)[![](https://cdn.openai.com/API/docs/images/images-gallery-2/mountain-map.png)](https://developers.openai.com/api/docs/guides/image-generation#)[![](https://cdn.openai.com/API/docs/images/images-gallery-2/shipyard-welding-documentary.png)](https://developers.openai.com/api/docs/guides/image-generation#)[![](https://cdn.openai.com/API/docs/images/images-gallery-2/coral-reef.png)](https://developers.openai.com/api/docs/guides/image-generation#)[![](https://cdn.openai.com/API/docs/images/images-gallery-2/smart-home-dashboard.png)](https://developers.openai.com/api/docs/guides/image-generation#)[![](https://cdn.openai.com/API/docs/images/images-gallery-2/abstract-orbit.png)](https://developers.openai.com/api/docs/guides/image-generation#)[![](https://cdn.openai.com/API/docs/images/images-gallery-2/airport-departure-kiosk-ui.png)](https://developers.openai.com/api/docs/guides/image-generation#)[![](https://cdn.openai.com/API/docs/images/images-gallery-2/icons-poster.png)](https://developers.openai.com/api/docs/guides/image-generation#)[![](https://cdn.openai.com/API/docs/images/images-gallery-2/3d-city.png)](https://developers.openai.com/api/docs/guides/image-generation#)[![](https://cdn.openai.com/API/docs/images/images-gallery-2/ink-wash-temple.png)](https://developers.openai.com/api/docs/guides/image-generation#)[![](https://cdn.openai.com/API/docs/images/images-gallery-2/cliffside-portrait.png)](https://developers.openai.com/api/docs/guides/image-generation#)
...
- **Generations**: [Generate images](https://developers.openai.com/api/docs/guides/image-generation#generate-images) from scratch based on a text prompt
- **Edits**: [Modify existing images](https://developers.openai.com/api/docs/guides/image-generation#edit-images) using a new prompt, either partially or entirely
...
The Responses API image generation tool uses its own GPT Image model selection. For details on mainline models that support calling this tool, refer to the [supported models](https://developers.openai.com/api/docs/guides/image-generation#supported-models) below.
...
Both APIs let you [customize output](https://developers.openai.com/api/docs/guides/image-generation#customize-image-output) by adjusting quality, size, format, and compression. Transparent backgrounds depend on model support.
...
To learn more about customizing the output (size, quality, format, compression), refer to the [customize image output](https://developers.openai.com/api/docs/guides/image-generation#customize-image-output) section below.
...
![Body Lotion](https://cdn.openai.com/API/docs/images/body-lotion.png)![Soap](https://cdn.openai.com/API/docs/images/soap.png)![Incense Kit](https://cdn.openai.com/API/docs/images/incense-kit.png)![Bath Bomb](https://cdn.openai.com/API/docs/images/bath-bomb.png)
...
|     |     |
| --- | --- |
| Popular sizes | - `1024x1024` (square)<br>  <br>- `1536x1024` (landscape)<br>  <br>- `1024x1536` (portrait)<br>  <br>- `2048x2048` (2K square)<br>  <br>- `2048x1152` (2K landscape)<br>  <br>- `3840x2160` (4K landscape)<br>  <br>- `2160x3840` (4K portrait)<br>  <br>- `auto` (default) |
| Size constraints | - Maximum edge length must be less than or equal to <br>  `3840px`<br>  <br>- Both edges must be multiples of `16px`<br>  <br>- Long edge to short edge ratio must not exceed `3:1`<br>  <br>- Total pixels must be at least `655,360` and no more than <br>  `8,294,400` |
...
text and image token prices, and use the [Calculating costs](https://developers.openai.com/api/docs/guides/image-generation#calculating-costs)
...
If you want to [stream image generation](https://developers.openai.com/api/docs/guides/image-generation#streaming) using the `partial_images` parameter, each partial image will incur an additional 100 image output tokens.
