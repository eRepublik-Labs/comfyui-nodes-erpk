...
Launched [server-side compaction](https://developers.openai.com/api/docs/guides/context-management#server-side-compaction) in the Responses API.
...
Added support for new built-in tools in the Responses API, including [remote MCP servers](https://developers.openai.com/api/docs/guides/tools-remote-mcp) and [code interpreter](https://developers.openai.com/api/docs/guides/tools-code-interpreter). [Learn more about tools](https://developers.openai.com/api/docs/guides/tools).
...
Launched support for [reinforcement fine-tuning](https://developers.openai.com/api/docs/guides/reinforcement-fine-tuning). Learn about available [fine-tuning methods](https://developers.openai.com/api/docs/guides/fine-tuning). [gpt-4.1-nano](https://developers.openai.com/api/docs/models/gpt-4.1-nano) is now available for fine-tuning.
...
- Released the [Responses API](https://developers.openai.com/api/docs/guides/responses-vs-chat-completions), a new API for creating and using agents and tools.
...
- Announced plans to bring all [Assistants API](https://developers.openai.com/api/docs/assistants) features to the easier to use [Responses API](https://developers.openai.com/api/docs/guides/responses-vs-chat-completions), with an anticipated sunset date for Assistants in 2026 (after achieving full feature parity).
...
Launched [Admin API Key Rotations](https://developers.openai.com/api/docs/api-reference/admin-api-keys), enabling customers to programmatically rotate their admin api keys.

Updated [Admin API Invites](https://developers.openai.com/api/docs/api-reference/invite), enabling customers to programmatically invite users to projects at the same time they are invited to organizations.
...
Added [`reasoning_effort` parameter](https://developers.openai.com/api/docs/api-reference/chat/create#chat-create-reasoning_effort) for o1 models.

Added [`developer` message role](https://developers.openai.com/api/docs/api-reference/chat/create#chat-create-messages) for o1 model. Note that o1-preview and o1-mini do not support system or developer messages.

Launched Preference Fine-tuning using [Direct Preference Optimization (DPO)](https://developers.openai.com/api/docs/guides/fine-tuning#preference).
...
Launched [Usage API](https://developers.openai.com/api/docs/api-reference/usage), enabling customers to programmatically query activities and spending across OpenAI APIs.
...
[Model distillation](https://developers.openai.com/api/docs/guides/distillation): Platform for fine-tuning cost-efficient models with your outputs from a large frontier model.

[Image fine-tuning](https://developers.openai.com/api/docs/guides/fine-tuning#vision): Fine-tune GPT-4o with images and text to improve vision capabilities.
...
GA release for [`gpt-4o-2024-08-06` fine-tuning](https://developers.openai.com/api/docs/guides/fine-tuning)—all API users can now fine-tune the latest GPT-4o model.
...
Launched [Admin and Audit Log APIs](https://developers.openai.com/api/docs/api-reference/administration), allowing customers to programmatically administer their organization and monitor changes using the audit logs. Audit logging must be enabled within [settings](https://developers.openai.com/api/docs/settings/organization/general).
...
Launched [fine-tuning for GPT-4o mini](https://developers.openai.com/api/docs/guides/fine-tuning), enabling even higher performance for specific use cases.
...
Released [Uploads](https://developers.openai.com/api/docs/api-reference/uploads) to upload large files in multiple parts.
...
Added support for [setting cost limits](https://developers.openai.com/settings/organization/general) on a per-project basis for pay as you go customers.
...
Added support for [image inputs to the Assistants API.](https://developers.openai.com/api/docs/assistants/overview)
...
Added [`stream_options: {"include_usage": true}`](https://developers.openai.com/api/docs/api-reference/chat/create#chat-create-stream_options) parameter to the Chat Completions and Completions APIs. Setting this gives developers access to usage stats when using streaming.

May 2

Update

Added [a new endpoint](https://developers.openai.com/api/docs/api-reference/messages/deleteMessage) to delete a message from a thread in the Assistants API.
...
Introduced a [series of updates to the Assistants API](https://developers.openai.com/api/docs/assistants/whats-new) , including a new file search tool allowing up to 10,000 files per assistant, new token controls, and support for tool choice.

Apr 16

Update

Introduced [project based hierarchy](https://developers.openai.com/api/settings/organization/general) for organizing work by projects, including the ability to create [API keys](https://developers.openai.com/api/docs/api-reference/authentication) and manage rate and cost limits on a per-project basis (cost limits available only for Enterprise customers).
...
Added support for [seed](https://developers.openai.com/api/docs/api-reference/fine-tuning/create) in the fine-tuning API

Added support for [checkpoints](https://developers.openai.com/api/docs/api-reference/fine-tuning/list-checkpoints) in the fine-tuning API

Added support for [adding Messages when creating a Run](https://developers.openai.com/api/docs/api-reference/runs/createRun#runs-createrun-additional_messages) in the Assistants API

Apr 1

Update

Added support for [filtering Messages by run\_id](https://developers.openai.com/api/docs/api-reference/messages/listMessages#messages-listmessages-run_id) in the Assistants API
...
Added support for [temperature](https://developers.openai.com/api/docs/api-reference/runs/createRun#runs-createrun-temperature) and [assistant message creation](https://developers.openai.com/api/docs/api-reference/messages/createMessage#messages-createmessage-role) in the Assistants API

Mar 14

Update

Added support for [streaming](https://developers.openai.com/api/docs/assistants/overview) in the Assistants API
...
Added [`dimensions` parameter](https://developers.openai.com/api/docs/api-reference/embeddings/create#embeddings-create-dimensions) to the Embeddings API
...
Added [`additional_instructions` parameter](https://developers.openai.com/api/docs/api-reference/runs/createRun#runs-createrun-additional_instructions) to run creation in the Assistants API

Dec 15

Update

Added [`logprobs` and `top_logprobs` parameters](https://developers.openai.com/api/docs/api-reference/chat/create#chat-create-logprobs) to the Chat Completions API

Dec 14

Update

Changed [function parameters](https://developers.openai.com/api/docs/api-reference/chat/create#chat-create-tools) argument on a tool call to be optional
...
Released [GPT-4 Turbo Preview](https://developers.openai.com/api/docs/models/gpt-4-turbo), [updated GPT-3.5 Turbo](https://developers.openai.com/api/docs/models/gpt-3-5-turbo), [GPT-4 Turbo with Vision](https://developers.openai.com/api/docs/guides/vision), [Assistants API](https://developers.openai.com/api/docs/assistants/overview), [DALL·E 3 in the API](https://developers.openai.com/api/docs/models/dall-e-3), and [text-to-speech API](https://developers.openai.com/api/docs/guides/text-to-speech)

Deprecated the Chat Completions `functions` parameter [in favor of `tools`](https://developers.openai.com/api/docs/api-reference/chat/create#chat-create-tools)
...
Added [`encoding_format` parameter](https://developers.openai.com/api/docs/api-reference/embeddings/create#embeddings-create-encoding_format) to the Embeddings API
...
Added [function calling support](https://developers.openai.com/api/docs/guides/fine-tuning#fine-tuning-examples) to the Fine-tuning API
