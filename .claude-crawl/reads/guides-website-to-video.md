[Skip to main content](https://hyperframes.heygen.com/guides/website-to-video#content-area)
...
## [​](https://hyperframes.heygen.com/guides/website-to-video\#getting-started)  Getting Started

1

[Navigate to header](https://hyperframes.heygen.com/guides/website-to-video#)
...
You don’t need to run `npx hyperframes capture` manually — the skill instructs the agent to capture as the first step. The capture command is documented [below](https://hyperframes.heygen.com/guides/website-to-video#capture-command) for advanced use.

## [​](https://hyperframes.heygen.com/guides/website-to-video\#how-the-pipeline-works)  How the Pipeline Works
...
## [​](https://hyperframes.heygen.com/guides/website-to-video\#video-types)  Video Types
...
## [​](https://hyperframes.heygen.com/guides/website-to-video\#enriching-captures-with-gemini-vision)  Enriching Captures with Gemini Vision

By default, captures describe assets using DOM context — alt text, nearby headings, CSS classes. Add a [Gemini API key](https://aistudio.google.com/apikey) for richer AI-powered descriptions using vision.Create a `.env` file in your project root:
...
## [​](https://hyperframes.heygen.com/guides/website-to-video\#capture-command)  Capture Command
...
### [​](https://hyperframes.heygen.com/guides/website-to-video\#what-gets-captured)  What Gets Captured
...
## [​](https://hyperframes.heygen.com/guides/website-to-video\#snapshot-command)  Snapshot Command
...
## [​](https://hyperframes.heygen.com/guides/website-to-video\#iterating)  Iterating
...
## [​](https://hyperframes.heygen.com/guides/website-to-video\#troubleshooting)  Troubleshooting
...
## [​](https://hyperframes.heygen.com/guides/website-to-video\#next-steps)  Next Steps
...
[Previous](https://hyperframes.heygen.com/concepts/determinism) [Prompt GuideHow to prompt Claude Code, Cursor, Codex, and other AI agents to author Hyperframes compositions — with copy-pasteable examples and vocabulary tables.\\
\\
Next](https://hyperframes.heygen.com/guides/prompting)

⌘I

On this page

- [Getting Started](https://hyperframes.heygen.com/guides/website-to-video#getting-started)
- [How the Pipeline Works](https://hyperframes.heygen.com/guides/website-to-video#how-the-pipeline-works)
- [Video Types](https://hyperframes.heygen.com/guides/website-to-video#video-types)
- [Enriching Captures with Gemini Vision](https://hyperframes.heygen.com/guides/website-to-video#enriching-captures-with-gemini-vision)
- [Capture Command](https://hyperframes.heygen.com/guides/website-to-video#capture-command)
- [What Gets Captured](https://hyperframes.heygen.com/guides/website-to-video#what-gets-captured)
- [Snapshot Command](https://hyperframes.heygen.com/guides/website-to-video#snapshot-command)
- [Iterating](https://hyperframes.heygen.com/guides/website-to-video#iterating)
- [Troubleshooting](https://hyperframes.heygen.com/guides/website-to-video#troubleshooting)
- [Next Steps](https://hyperframes.heygen.com/guides/website-to-video#next-steps)
