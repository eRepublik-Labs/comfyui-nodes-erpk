[Skip to main content](https://hyperframes.heygen.com/guides#content-area)
...
## [​](https://hyperframes.heygen.com/guides\#getting-started)  Getting Started

1

[Navigate to header](https://hyperframes.heygen.com/guides#)
...
You don’t need to run `npx hyperframes capture` manually — the skill instructs the agent to capture as the first step. The capture command is documented [below](https://hyperframes.heygen.com/guides#capture-command) for advanced use.

## [​](https://hyperframes.heygen.com/guides\#how-the-pipeline-works)  How the Pipeline Works
...
## [​](https://hyperframes.heygen.com/guides\#video-types)  Video Types
...
## [​](https://hyperframes.heygen.com/guides\#enriching-captures-with-gemini-vision)  Enriching Captures with Gemini Vision
...
## [​](https://hyperframes.heygen.com/guides\#capture-command)  Capture Command
...
### [​](https://hyperframes.heygen.com/guides\#what-gets-captured)  What Gets Captured
...
## [​](https://hyperframes.heygen.com/guides\#snapshot-command)  Snapshot Command
...
## [​](https://hyperframes.heygen.com/guides\#iterating)  Iterating
...
## [​](https://hyperframes.heygen.com/guides\#troubleshooting)  Troubleshooting
...
## [​](https://hyperframes.heygen.com/guides\#next-steps)  Next Steps
...
- [Getting Started](https://hyperframes.heygen.com/guides#getting-started)
- [How the Pipeline Works](https://hyperframes.heygen.com/guides#how-the-pipeline-works)
- [Video Types](https://hyperframes.heygen.com/guides#video-types)
- [Enriching Captures with Gemini Vision](https://hyperframes.heygen.com/guides#enriching-captures-with-gemini-vision)
- [Capture Command](https://hyperframes.heygen.com/guides#capture-command)
- [What Gets Captured](https://hyperframes.heygen.com/guides#what-gets-captured)
- [Snapshot Command](https://hyperframes.heygen.com/guides#snapshot-command)
- [Iterating](https://hyperframes.heygen.com/guides#iterating)
- [Troubleshooting](https://hyperframes.heygen.com/guides#troubleshooting)
- [Next Steps](https://hyperframes.heygen.com/guides#next-steps)
