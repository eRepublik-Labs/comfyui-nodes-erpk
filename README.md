...
- **MiniMax H3 Text-to-Video** / **Image-to-Video** / **Reference-to-Video** - MiniMax's hosted H3 edition: picture and native stereo audio in one pass at 768p or 2k, 4-15s. Audio is steered by an `Audio:` line in the prompt rather than a toggle. Reference-to-Video takes up to 9 images, 3 videos and 3 audios, each cited in the prompt by bracket tag
