...
- A `masks` output emits a frame-sized MASK batch (one per region, in region order): scanned regions use their segmentation, hand-drawn regions get filled rectangles - ready for inpainting chains
