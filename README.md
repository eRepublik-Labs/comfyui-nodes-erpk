...
- Optional grid with selectable density (click the grid button to cycle off / 6 / 12 / 24) and snap-to-grid; drawing, moving, and resizing quantize to grid lines, and the preference saves with the workflow
