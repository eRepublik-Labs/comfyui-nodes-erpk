...
- Exact geometry: the inspector's `⌗` button opens an X/Y/W/H popover in frame pixels for the selected region; arrow keys nudge the selection by 1px (10px with Shift) and Alt+arrows resize
