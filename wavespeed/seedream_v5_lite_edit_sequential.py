# ABOUTME: ByteDance Seedream V5.0 Lite Edit Sequential node for multi-image editing via WaveSpeed AI.
# ABOUTME: Multi-image editing with sequential generation at higher minimum resolution.

from comfy_api.latest import IO
from .seedream_v5_lite import SEEDREAM_V5_LITE_SIZE_PRESETS


class SeedreamV5LiteEditSequentialNode(IO.ComfyNode):
    """
    ByteDance Seedream V5.0 Lite Edit Sequential Image Editor Node

    Multi-image editing with sequential generation at higher minimum resolution.
    """

    @classmethod
    def define_schema(cls):
        return IO.Schema(
            node_id="SeedreamV5LiteEditSequentialNode",
            display_name="Bytedance Seedream V5.0 Lite Edit Sequential",
    ...
    async def execute(cls, prompt, max_images, size_preset, client=None, image_url=None,
        ...
        from .wavespeed_api.requests.seedream_v5_lite_edit_sequential import SeedreamV5LiteEditSequential
        ...
        request = SeedreamV5LiteEditSequential(
