...
| **MiniMax H3 Reference-to-Video** | MiniMax H3 (MiniMax-hosted) | Up to 9 reference images, 3 videos, 3 audios, each cited in the prompt by `<Picture N>` / `<Video N>` / `<Audio N>` tags. No API seed | 4-15s | 16:9/9:16/1:1/4:3/3:4/21:9 · 768p/2k | [Link](https://wavespeed.ai/models/minimax/h3/reference-to-video) |
...
| **MiniMax H3 Video Extend** | MiniMax H3 (open weights) | Append a new segment after a clip's last frame, optionally toward a target end frame; chains off any node's video_url | 3-15s new segment | 480p/540p/768p/1080p | [Link](https://wavespeed.ai/models/wavespeed-ai/minimax-h3/video-extend) |
