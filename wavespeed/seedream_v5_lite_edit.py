# ABOUTME: ByteDance Seedream V5.0 Lite Edit node for image editing via WaveSpeed AI.
# ABOUTME: Higher minimum resolution image editing with enhanced typography.

from comfy_api.latest import IO
from .seedream_v5_lite import SEEDREAM_V5_LITE_SIZE_PRESETS


class SeedreamV5LiteEditNode(IO.ComfyNode):
    """
    ByteDance Seedream V5.0 Lite Edit Image Editor Node

    Higher minimum resolution image editing with enhanced typography.
    """

    @classmethod
    def define_schema(cls):
        return IO.Schema(
            node_id="SeedreamV5LiteEditNode",
            display_name="Bytedance Seedream V5.0 Lite Edit",
    ...
    def execute(cls, prompt, image_url, size_preset, client=None, width=2048, height=2048,
        ...
        from .wavespeed_api.requests.seedream_v5_lite_edit import SeedreamV5LiteEdit
