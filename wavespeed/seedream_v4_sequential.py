# ABOUTME: ByteDance Seedream V4 Sequential node for multi-image generation via WaveSpeed AI.
# ABOUTME: Generates multiple coherent images with cross-image consistency in a single pipeline.

from comfy_api.latest import IO
from .seedream_v4 import SEEDREAM_V4_SIZE_PRESETS


class SeedreamV4SequentialNode(IO.ComfyNode):
    """
    ...
    def define_schema(cls):
        return IO.Schema(
            node_id="SeedreamV4SequentialNode",
            display_name="Bytedance Seedream V4 Sequential",
    ...
    @classmethod
    async def execute(cls, prompt, max_images, size_preset, client=None, width=1408, height=1408,
