...
class SeedreamV4_5Sequential(BaseRequest):
    """
    ByteDance Seedream-V4.5 Sequential text to image model
    Enables multi-image generation with cross-image consistency and enhanced typography
    """
    ...
    def get_api_path(self):
        """Gets the API path."""
        return "/api/v3/bytedance/seedream-v4.5/sequential"
