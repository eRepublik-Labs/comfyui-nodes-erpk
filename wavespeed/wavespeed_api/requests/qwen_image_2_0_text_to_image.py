# ABOUTME: Qwen Image 2.0 text-to-image request for WaveSpeed AI.
# ABOUTME: Routes to the qwen-image-2.0 text-to-image endpoint.
...
class QwenImage20TextToImage(BaseRequest):
    """
    ...
    size: Optional[str] = Field(
        default="1024*1024",
        description="Image dimensions in pixels (width*height format). Max resolution: 1536x1536 pixels.",
    )
    ...
    def get_api_path(self):
        ...
        return "/api/v3/wavespeed-ai/qwen-image-2.0/text-to-image"
