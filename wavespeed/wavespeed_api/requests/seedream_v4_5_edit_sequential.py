...
class SeedreamV4_5EditSequential(BaseRequest):
    """
    ByteDance Seedream V4.5 Edit Sequential image editing model
    Enables multi-image editing with sequential generation and enhanced typography
    """
    ...
    def get_api_path(self):
        """Gets the API path."""
        return "/api/v3/bytedance/seedream-v4.5/edit-sequential"
