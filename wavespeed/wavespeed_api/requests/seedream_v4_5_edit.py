...
class SeedreamV4_5Edit(BaseRequest):
    """
    ByteDance Seedream V4.5 Edit image editing model with enhanced typography
    """
    ...
    size: Optional[str] = Field(
        default="2048*2048",
        description="The size of the generated media, supporting up to 4K resolution.",
    )
    ...
    def get_api_path(self):
        """Gets the API path."""
        return "/api/v3/bytedance/seedream-v4.5/edit"
