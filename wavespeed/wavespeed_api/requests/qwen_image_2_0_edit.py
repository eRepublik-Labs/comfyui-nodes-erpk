# ABOUTME: Qwen Image 2.0 edit request for WaveSpeed AI.
# ABOUTME: Routes to the qwen-image-2.0 edit endpoint, accepts up to 3 reference images.
...
class QwenImage20Edit(BaseRequest):
    """
    Qwen Image 2.0 Edit model for image editing with multiple reference images
    """
    ...
    def get_api_path(self):
        ...
        return "/api/v3/wavespeed-ai/qwen-image-2.0/edit"
