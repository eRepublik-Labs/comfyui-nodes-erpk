# ABOUTME: JibMix Qwen Image text-to-image generation node for WaveSpeed AI.
# ABOUTME: Portrait-optimized model with the same parameters as Qwen Image.

from comfy_api.latest import IO


class JibMixQwenImageNode(IO.ComfyNode):
    """
    JibMix Qwen Image Text-to-Image Generator Node

    Portrait-optimized model that generates high-quality images from text prompts.
    ...
    def define_schema(cls):
        return IO.Schema(
            node_id="JibMixQwenImageNode",
            display_name="JibMix Qwen Image",
    ...
    def execute(cls, prompt="", client=None, width=1024, height=1024,
        ...
        from .wavespeed_api.requests.jibmix_qwen_image import JibMixQwenImage
