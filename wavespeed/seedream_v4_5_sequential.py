# ABOUTME: ByteDance Seedream V4.5 Sequential node for multi-image generation via WaveSpeed AI.
# ABOUTME: Generates multiple coherent images with cross-image consistency and enhanced typography.

from comfy_api.latest import IO
from .seedream_v4_5 import SEEDREAM_V4_5_SIZE_PRESETS


class SeedreamV4_5SequentialNode(IO.ComfyNode):
    """
    ...
    def define_schema(cls):
        return IO.Schema(
            node_id="SeedreamV4_5SequentialNode",
            display_name="Bytedance Seedream V4.5 Sequential",
    ...
    @classmethod
    async def execute(cls, prompt, max_images, size_preset, client=None, width=2048, height=2048,
