# ABOUTME: ByteDance Seedream V4.5 Edit Sequential node for multi-image editing via WaveSpeed AI.
...
class SeedreamV4_5EditSequentialNode(IO.ComfyNode):
    """
    ...
    def define_schema(cls):
        return IO.Schema(
            node_id="SeedreamV4_5EditSequentialNode",
            display_name="Bytedance Seedream V4.5 Edit Sequential",
