...
class TestHistoryCleanerWrapper:
    ...
    def test_always_calls_original(self):
        ...
        from erpk.history_cleaner import make_wrapped_task_done
        ...
        with patch("erpk.history_cleaner.get_comfy_setting", return_value=False):
            bound(1, {}, {})
    ...
    def test_schedules_delete_when_setting_on(self):
        ...
        with patch("erpk.history_cleaner.get_comfy_setting", return_value=True):
            with patch("threading.Thread") as mock_thread:
...
class TestInstall:
    ...
    def test_patches_task_done(self):
        from erpk.history_cleaner import install
        ...
        with patch("erpk.history_cleaner.PromptServer") as mock_ps:
